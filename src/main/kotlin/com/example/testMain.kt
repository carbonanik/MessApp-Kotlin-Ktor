...
//    countries.add(Country("as", "1684", "American Samoa"))
//    countries.add(Country("ad", "376", "Andorra"))
//    countries.add(Country("ao", "244", "Angola"))
//    countries.add(Country("ai", "1264", "Anguilla"))
//    countries.add(Country("ag", "1268", "Antigua and Barbuda"))
...
//    countries.add(Country("bs", "1242", "Bahamas"))
//    countries.add(Country("bh", "973", "Bahrain"))
//    countries.add(Country("bd", "880", "Bangladesh"))
//    countries.add(Country("bb", "1246", "Barbados"))
...
//    countries.add(Country("bm", "1441", "Bermuda"))
//    countries.add(Country("bt", "975", "Bhutan"))
//    countries.add(Country("bo", "591", "Bolivia"))
//    countries.add(Country("nl", "599", "Bonaire, Sint Eustatius & Saba"))
//    countries.add(Country("ba", "387", "Bosnia & Herzegovina"))
//    countries.add(Country("bw", "267", "Botswana"))
//    countries.add(Country("br", "55", "Brazil"))
//    countries.add(Country("vg", "1284", "British Virgin Islands"))
...
//    countries.add(Country("ky", "1345", "Cayman Islands"))
//    countries.add(Country("cf", "236", "Central African Rep."))
...
//    countries.add(Country("cd", "243", "Congo Democratic Rep."))
//    countries.add(Country("cg", "242", "Congo Rep."))
...
//    countries.add(Country("dm", "1767", "Dominica"))
//    countries.add(Country("do", "1809", "Dominican Rep."))
//    countries.add(Country("do", "1829", "Dominican Rep."))
//    countries.add(Country("do", "1849", "Dominican Rep."))
...
//    countries.add(Country("gd", "1473", "Grenada"))
//    countries.add(Country("gp", "450", "Guadeloupe"))
//    countries.add(Country("gu", "1671", "Guam"))
...
//    //
//    countries.add(Country("ir", "98", "Iran, Islamic Rep."))
...
//    countries.add(Country("jm", "1876", "Jamaica"))
...
//    countries.add(Country("ms", "1664", "Montserrat"))
...
//    countries.add(Country("mp", "1670", "Northern Mariana Islands"))
...
//    countries.add(Country("pr", "1787", "Puerto Rico"))
//    countries.add(Country("pr", "1939", "Puerto Rico"))
...
//    countries.add(Country("sh", "247", "Saint Helena"))
//    countries.add(Country("sh", "290", "Saint Helena"))
//    countries.add(Country("kn", "1869", "Saint Kitts & Nevis"))
//    countries.add(Country("lc", "158", "Saint Lucia"))
//    countries.add(Country("pm", "508", "Saint Pierre & Miquelon"))
//    countries.add(Country("vc", "1784", "Saint Vincent & The Grenadines"))
...
//    countries.add(Country("tt", "1868", "Trinidad & Tobago"))
...
//    countries.add(Country("tc", "1649", "Turks & Caicos Islands"))
//    countries.add(Country("tv", "688", "Tuvalu"))
//    countries.add(Country("vi", "1340", "US Virgin Islands"))
